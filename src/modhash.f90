module modhash
 ...
 interface hash
   module procedure hashword_int32
   module procedure hashword_real32
...
contains
 ...
 pure function hashword_int32(k, seed) result(c)
 ...
 pure function hashword_real32(k, seed) result(c)
